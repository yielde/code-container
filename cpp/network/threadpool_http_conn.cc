...
const char* error_400_from =
    "Your request has bad syntax or is inherently impossible to satisfy\n";
const char* error_403_title = "Forbidden";
const char* error_403_from =
    "You do not have permission to get file from this server\n";
const char* error_404_title = "Not Found";
const char* error_404_from =
    "The requested file was not found on this server\n";
const char* error_500_title = "Internal Error";
const char* error_500_from =
    "There was unusual problem serving the requested file\n";
...
http_conn::HTTP_CODE http_conn::process_read() {
  ...
  while (((m_check_state == CHECK_STAT_CONTENT) && (line_status == LINE_OK)) ||
